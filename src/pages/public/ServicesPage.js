...
export default function ServicesPage() {
  ...
  // ✅ Filter only from real Firebase data (not DEFAULT)
  // While loading, show skeletons — not default fake data
  ...
  return (
    <>
      <SEO
        title="All Services – Ration Card, PAN Card, TNPSC & More"
        description="Royal Computers offers 73+ government services — Ration Card (new, correction, surrender), Community Certificate, Income Certificate, PAN Card, Passport, Voter ID, Aadhar Update, Driving Licence, TNPSC & NEET Applications. Visit us in Tamil Nadu."
        keywords="Ration Card apply Tamil Nadu, Community Certificate BC MBC, Income Certificate online, PAN Card new application, Passport renewal, Voter ID apply, Aadhar update, Driving Licence, TNPSC application, NEET 2026"
        url="/services"
      />
      ...
      <div style={{ background: '#f0fdf4', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '40px 1.25rem' }}>
          ...
          <div style={{ position: 'relative', marginBottom: 16 }}>
            ...
            <input
              ...
              style={{
                ...
                border: '2px solid #bbf7d0', background: 'white', fontSize: 14,
          ...
          {/* ✅ 3 states: loading → data → empty */}

          {/* State 1: Loading — show skeletons */}
          {loading && (
            <>
          ...
          {/* State 2: Loaded — show filtered results */}
          ...
          {/* State 3: Loaded but no results (search/filter no match) */}
          {!loading && filtered.length === 0 && (
