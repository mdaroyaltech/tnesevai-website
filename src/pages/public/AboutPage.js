...
const WHY = [
  ...
  { icon: <FaUsers />, en: '10,000+ Happy Customers', ta: '10,000+ திருப்தியான வாடிக்கையாளர்கள்', color: '#1d4ed8' },
...
export default function AboutPage() {
  ...
  return (
    <>
      <SEO
        title="About Us – Authorized TNeSevai & Digital Seva Center Tamil Nadu"
        description="Royal Computers is an authorized TNeSevai and Digital Seva center in Tamil Nadu with 10+ years experience. VLE Code: 642198200013. We provide fast and reliable government digital services to 10,000+ happy customers."
        keywords="Royal Computers about, TNeSevai authorized center, Digital Seva VLE Tamil Nadu, VLE 642198200013, government services center Tamil Nadu, 10 years experience"
        url="/about"
      />
