...
export default function ExamDatesPage() {
  ...
  return (
    <>
      <SEO
        title="Exam Dates 2026 – TNPSC, NEET, TNEA, TRB Applications"
        description="Important exam and application dates for 2026 — TNPSC Group 1, 2, 4, VAO, NEET UG 2026 (3 May 2026), TNEA, TRB Teacher Recruitment, TN Police SI PC. Apply at Royal Computers Tamil Nadu."
        keywords="TNPSC exam dates 2026, NEET 2026 application date, NEET UG 3 May 2026, TNPSC Group 4 2026, TNPSC VAO 2026, TNEA 2026, TRB teacher recruitment, TN Police recruitment 2026, BC MBC scholarship 2026"
        url="/exams"
      />
