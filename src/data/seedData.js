...
export const ALL_SERVICES = [
  ...
  { name: 'Ration Card - Surrender',             nameTa: 'ரேஷன் கார்டு - ஒப்படைப்பு',              icon: '↪', category: 'tnesevai',    desc: 'Surrender ration card',                         descTa: 'ரேஷன் கார்டு ஒப்படைப்பு' },
  ...
  { name: 'Residence Certificate',               nameTa: 'வசிப்பிட சான்றிதழ்',                      icon: '🏠', category: 'tnesevai',    desc: 'Residence / address proof certificate',         descTa: 'வசிப்பிட / முகவரி சான்றிதழ்' },
  ...
  { name: 'PAN Card - Reprint / Duplicate',      nameTa: 'பான் கார்டு - மறுபிரிண்ட்',               icon: '🖨', category: 'digitalSeva', desc: 'Reprint lost or damaged PAN card',              descTa: 'தொலைந்த அல்லது சேதமடைந்த PAN கார்டு மறுபிரிண்ட்' },
  ...
  { name: 'Passport - Renewal',                  nameTa: 'பாஸ்போர்ட் - புதுப்பித்தல்',              icon: '♻️', category: 'digitalSeva', desc: 'Renew expired or expiring passport',            descTa: 'காலாவதியான பாஸ்போர்ட் புதுப்பித்தல்' },
  ...
  { name: 'Property Tax Payment',                nameTa: 'சொத்து வரி செலுத்துதல்',                  icon: '🏠', category: 'digitalSeva', desc: 'Local body property tax payment',               descTa: 'உள்ளாட்சி சொத்து வரி செலுத்துதல்' },
  ...
  { name: 'Print & Xerox (Color)',               nameTa: 'பிரிண்ட் & ஸீரோக்ஸ் (வண்ண)',              icon: '🖨', category: 'digitalSeva', desc: 'Color and B/W printing service',                descTa: 'வண்ண மற்றும் கருப்பு வெள்ளை பிரிண்ட்' },
  ...
  { name: 'TNPSC VAO Application',               nameTa: 'TNPSC VAO விண்ணப்பம்',                    icon: '🏠', category: 'tnpsc',       desc: 'Village Administrative Officer recruitment',    descTa: 'கிராம நிர்வாக அலுவலர் ஆட்சேர்ப்பு' },
  { name: 'TNPSC CCSE I Application',            nameTa: 'TNPSC CCSE I விண்ணப்பம்',                 icon: '🎖', category: 'tnpsc',       desc: 'Combined Civil Services Exam – I',              descTa: 'ஒருங்கிணைந்த சிவில் சேவைகள் தேர்வு – I' },
  ...
  { name: 'TNUSRB Recruitment',                  nameTa: 'TNUSRB ஆட்சேர்ப்பு',                      icon: '🛡️', category: 'tnpsc',       desc: 'TN Uniformed Services Recruitment Board',      descTa: 'TN சீருடை சேவை ஆட்சேர்ப்பு குழு' },
  ...
  { name: 'NEET PG Application',                 nameTa: 'NEET PG விண்ணப்பம்',                      icon: '🩺', category: 'education',   desc: 'NEET PG Medical post graduate entrance',        descTa: 'NEET PG மருத்துவ முதுகலை நுழைவு' },
...
export const ALL_EXAMS = [
  ...
  // ── CURRENTLY ACTIVE / URGENT ──
  {
    name: 'NEET UG 2026',
    nameTa: 'NEET UG 2026',
    icon: '🩺',
    body: 'National Testing Agency (NTA)',
    lastDate: '2026-03-11',   // Registration closed 11 Mar — correction window open
    examDate: '2026-05-03',   // Exam: 3 May 2026, 2PM–5PM
    status: 'ongoing',        // Registration closed but exam approaching — ACTIVE
    applyLink: 'https://neet.nta.nic.in',
    note: 'Registration closed. Exam on 3 May 2026. Correction window was Mar 12–14.',
  },
  {
    ...
    lastDate: '2026-03-02',   // Hall ticket released 2 Mar
    examDate: '2026-03-15',   // Mains: 15 March 2026
    status: 'ongoing',        // Exam happening this month
    applyLink: 'https://www.tnpsc.gov.in',
    note: 'Mains exam on 15 March 2026. Hall ticket already released.',
  },
  {
    name: 'TNPSC CTS Exam 2026 (Non-Interview)',
    nameTa: 'TNPSC CTS தேர்வு 2026',
    icon: '⚙️',
    body: 'Tamil Nadu Public Service Commission',
    lastDate: '2026-03-12',   // Hall ticket: 12 Mar
    examDate: '2026-03-22',   // Exam: 22–25 March 2026
    status: 'ongoing',
    applyLink: 'https://www.tnpsc.gov.in',
    note: 'Computer Based Test: 22–25 March 2026. Hall ticket released.',
  },

  // ── UPCOMING 2026 (TNPSC Annual Planner 2026) ──
  {
    name: 'TNPSC Group 1 Prelims 2026',
    nameTa: 'TNPSC குழு 1 முன்னோட்டத் தேர்வு 2026',
    icon: '🏆',
    body: 'Tamil Nadu Public Service Commission',
    lastDate: '2026-07-01',   // Notification expected ~May 2026
    examDate: '2026-09-06',   // As per TNPSC Annual Planner 2026
    status: 'upcoming',
    applyLink: 'https://www.tnpsc.gov.in',
    note: 'As per TNPSC Annual Planner 2026. Official notification awaited.',
  },
  {
    name: 'TNPSC Group 2 & 2A Prelims 2026',
    nameTa: 'TNPSC குழு 2 & 2A முன்னோட்டத் தேர்வு 2026',
    icon: '🥈',
    body: 'Tamil Nadu Public Service Commission',
    lastDate: '2026-09-01',   // Notification expected ~Aug 2026
    examDate: '2026-10-25',   // As per TNPSC Annual Planner 2026
    status: 'upcoming',
    applyLink: 'https://www.tnpsc.gov.in',
    note: 'Prelims: 25 Oct 2026. As per TNPSC Annual Planner 2026.',
  },
  {
    name: 'TNPSC Group 4 / CCSE IV 2026',
    nameTa: 'TNPSC குழு 4 / CCSE IV 2026',
    icon: '📝',
    body: 'Tamil Nadu Public Service Commission',
    lastDate: '2026-11-01',   // Notification expected ~Oct 2026
    examDate: '2026-12-20',   // As per TNPSC Annual Planner 2026
    status: 'upcoming',
    applyLink: 'https://www.tnpsc.gov.in',
    note: 'Exam: 20 Dec 2026. As per TNPSC Annual Planner 2026.',
  },
  {
    name: 'TNEA 2026 Counselling',
    nameTa: 'TNEA 2026 கவுன்சிலிங்',
    icon: '🏛️',
    body: 'Anna University, Chennai',
    lastDate: '2026-06-30',
    examDate: '',
    status: 'upcoming',
    applyLink: 'https://www.tneaonline.org',
    note: 'Tamil Nadu Engineering Admissions. Dates tentative — check official site.',
  },
  {
    name: 'JEE Main 2026 Session 1',
    nameTa: 'JEE Main 2026 Session 1',
    icon: '⚙️',
    body: 'National Testing Agency (NTA)',
    lastDate: '2026-11-30',   // Tentative — NTA will announce
    examDate: '2027-01-15',   // Tentative Jan 2027
    status: 'upcoming',
    applyLink: 'https://jeemain.nta.ac.in',
    note: 'Tentative. NTA will release official notification.',
  },
  {
    name: 'TN Police Recruitment 2026',
    nameTa: 'TN போலீஸ் ஆட்சேர்ப்பு 2026',
    icon: '👮',
    body: 'TNUSRB',
    lastDate: '2026-07-31',
    examDate: '2026-10-01',
    ...
    note: 'Dates tentative. Watch TNUSRB official site for notification.',
  },
  {
    name: 'TRB Teacher Recruitment 2026',
    nameTa: 'TRB ஆசிரியர் ஆட்சேர்ப்பு 2026',
    icon: '👩‍🏫',
    ...
    note: 'Tentative. Check TRB official website.',
  },
  {
    name: 'BC / MBC Scholarship 2026-27',
    nameTa: 'BC / MBC உதவித்தொகை 2026-27',
    icon: '🎓',
    body: 'TN Backward Classes Welfare Dept',
    lastDate: '2026-10-31',
    examDate: '',
    status: 'upcoming',
    applyLink: 'https://www.bcmbcmw.tn.gov.in',
  },
  {
    name: 'SC / ST Scholarship 2026-27',
    nameTa: 'SC / ST உதவித்தொகை 2026-27',
    icon: '🎓',
    body: 'Adi Dravidar & Tribal Welfare Dept',
    lastDate: '2026-10-31',
    examDate: '',
    status: 'upcoming',
    applyLink: 'https://www.adi-dravidar.tn.gov.in',
  },
];
